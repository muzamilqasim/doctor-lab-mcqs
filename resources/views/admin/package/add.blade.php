...
<section class="content">
	...
	<div class="container-fluid">
		<form class="saveForm" data-storeURL="{{ route('admin.package.store') }}">
			<div class="row">
				<div class="col-md-12">
					<div class="card mb-3">
						<div class="card-body">                             
							<div class="row">
								...
								<div class="col-md-12">
									<div class="mb-3">
										...
										<input type="number" name="duration" id="duration" class="form-control" placeholder="Enter duration in days" required min="1">
									</div>
								</div>
								<div class="col-md-12">
									<div class="mb-3">
