...
<section class="content">
	...
	<div class="container-fluid">
		<form class="saveForm" data-storeURL="{{ route('admin.users.update', $data->id) }}">
			@method('PUT')
			<div class="row">
				<div class="col-md-12">
					<div class="card mb-3">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="mb-3">
										...
										<input type="text" name="phone_number" id="phone_number" value="{{ $data->phone_number }}" class="form-control" placeholder="Phone Number">
										<p></p>
									</div>
								</div>
								<div class="col-md-6">
									...
									<div class="mb-3">
										...
										<select class="form-control" name="career_stage" id="career_stage">
											...
											@foreach($career as $row)
												<option value="{{ $row->id }}" {{ ($row->id == $data->career_stage_id) ? 'selected' : '' }}>{{ $row->name }}</option>
											@endforeach
										</select>
										<p></p>
									</div>
