...
use App\Models\{Option, Category, SubCategory, Question, TestResult, Explanation};
...
class TestController extends Controller
{
    public function startTest(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'category_ids.*' => 'exists:sub_categories,id',
        ]);
        ...
        $categoriesWithQuestions = SubCategory::whereIn('id', $categoryIds)
            ->with('questions')
